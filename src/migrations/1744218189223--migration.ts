...
export class  Migration1744218189223 implements MigrationInterface {
    name = ' Migration1744218189223'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "warehouse"."unit" ("id" SERIAL NOT NULL, "created_by" integer, "updated_by" integer, "deleted_by" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "code" character varying NOT NULL, "bank_id" integer, "warehouse_id" integer, "description" character varying, CONSTRAINT "PK_4252c4be609041e559f0c80f58a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "warehouse"."category" ("id" SERIAL NOT NULL, "created_by" integer, "updated_by" integer, "deleted_by" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "code" character varying NOT NULL, "description" character varying, "bank_id" integer, "warehouse_id" integer, "unit_id" integer NOT NULL, CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "warehouse"."category" ADD CONSTRAINT "FK_c5a39e53027687d3ef705f8d031" FOREIGN KEY ("unit_id") REFERENCES "warehouse"."unit"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
